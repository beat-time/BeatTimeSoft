namespace OpenCvSharp.Demo
{
    ...
    public class FaceRecognizerController : UnityEngine.MonoBehaviour
    {
        ...
        public UnityEngine.Texture2D noImage;
        ...
        void Start()
        {
            ...
            ConvertTexture convertTexture = new ConvertTexture();
            sample = convertTexture.Convert(photoPlayerController.getTurnPlayerOne());
            ...
            foreach (var faceRect in rawFaces)
            {
                ...
                ////Save face
                convertTexture.SaveFace(sample, faceRect.X, faceRect.Y, faceRect.Width, faceRect.Height, photoPlayerController.getTurnPlayerOne());
